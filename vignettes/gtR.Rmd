...
* Run a query for certain records for a specified resource (eg organisation/person/project) (`query_resource_combination()`). This requires an id for the resource that you would like to query, which can be obtained via `query_resource_all()`.
